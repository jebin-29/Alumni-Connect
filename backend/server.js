...
app.use(cors({
  ...
  origin: ['http://localhost:5173', 'http://localhost:3000', 'https://alumni-connect-eec8net5n-jebin-ds-projects.vercel.app/', 'https://alumni-connect-puce.vercel.app/'],
...
const io = new Server(server, {
  cors: {
    origin: "https://alumni-connect-puce.vercel.app/", // Updated the socket CORS origin
    methods: ["GET", "POST"],
    credentials: true,
    allowedHeaders: ["Content-Type", "Authorization"]
  }
